...
import 'package:project_jewerly/CRUD/editKalung.dart';
import 'package:project_jewerly/adminPage.dart';

import '../editGelang.dart';

class ItemKalung extends StatelessWidget {
  final String id;
  final String nama;
  final String jenis;
  ...
  ItemKalung(this.id, this.nama, this.jenis, this.kategori, this.stok,
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Edit_Kalung(id, nama,
