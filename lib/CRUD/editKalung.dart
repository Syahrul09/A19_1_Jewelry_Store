...
class Edit_Kalung extends StatefulWidget {
  final String id;
  final String nama;
  final String jenis;
  ...
  final String harga;
  final String desc;
  const Edit_Kalung(this.id, this.nama, this.jenis, this.kategori, this.stok,
      this.harga, this.desc,
      {Key? key})
      : super(key: key);
  @override
  State<Edit_Kalung> createState() => _Edit_KalungState();
}

class _Edit_KalungState extends State<Edit_Kalung> {
