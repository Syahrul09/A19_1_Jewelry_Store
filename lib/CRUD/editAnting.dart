...
class Edit_Anting extends StatefulWidget {
  final String id;
  final String nama;
  final String jenis;
  ...
  final String harga;
  final String desc;
  const Edit_Anting(this.id, this.nama, this.jenis, this.kategori, this.stok,
      this.harga, this.desc,
      {Key? key})
      : super(key: key);
  @override
  State<Edit_Anting> createState() => _Edit_AntingState();
}

class _Edit_AntingState extends State<Edit_Anting> {
  ...
  Future unggahFile(ambilFile, id) async {
    ...
    Reference ref = storage.ref().child("gambar_anting").child(fileName);
    UploadTask uploadTask = ref.putFile(imageFile);
    TaskSnapshot snapshot = await uploadTask.whenComplete(() => null);
    url = await snapshot.ref.getDownloadURL();

    produk_anting.doc(id).update({
